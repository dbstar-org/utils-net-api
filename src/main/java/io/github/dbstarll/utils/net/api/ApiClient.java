...
public abstract class ApiClient {
  ...
  protected final RequestBuilder get(String path) throws ApiException {
  ...
  protected final RequestBuilder post(String path) throws ApiException {
  ...
  protected final RequestBuilder delete(String path) throws ApiException {
    return delete(uriResolver.resolve(path));
  }

  protected RequestBuilder preProcessing(RequestBuilder builder) throws ApiException {
  ...
  protected final <T> T execute(HttpUriRequest request, ResponseHandler<T> responseHandler)
          throws IOException, ApiException {
    try {
      return postProcessing(
              httpClient.execute(notNull(request, "request is null"), notNull(responseHandler, "responseHandler is null")));
